...
public class LoadAwarePoolGrouping implements LoadAwareCustomStreamGrouping {
    private static final Logger logger = LoggerFactory.getLogger(LoadAwarePoolGrouping.class);
    ...
    public List<Integer> chooseTasks(int taskId, List<Object> values) {
        ...
        if (targets.length == 0) {
            logger.info("targets.length={}", targets.length);
            return rets[0];
        }
